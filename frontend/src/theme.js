...
const theme = createTheme({
  ...
  typography: {
    fontFamily: '"Urbanist", "Segoe UI", "Roboto", "Oxygen", "Ubuntu", "Cantarell", sans-serif',
    ...
    MuiButton: {
      ...
      styleOverrides: {
        ...
        containedPrimary: {
          ...
          color: '#FFFFFF',
          '&:hover': {
            background: 'linear-gradient(135deg, #C4924A 0%, #B38340 100%)',
          },
          '&:disabled': {
            background: '#E2E8F0',
            color: '#CBD5E1',
        ...
        outlined: {
          ...
          '&:hover': {
            borderColor: '#C4924A',
            backgroundColor: 'rgba(212, 161, 96, 0.05)',
          },
        },
        outlinedSecondary: {
          borderColor: '#1E2E52',
